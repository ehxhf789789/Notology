...
const ko: Record<string, string> = {
  ...
  canvasEditNode: '노드 편집',
  canvasDeleteNode: '노드 삭제',
  canvasColor: '색상',
  canvasShape: '모양',
  canvasExpand: '펼치기',
  canvasCollapse: '접기',
  canvasTextAlign: '텍스트 정렬',
  canvasAlignTopLeft: '좌상단',
  canvasAlignCenter: '중앙',
...
const en: Record<string, string> = {
  ...
  canvasEditNode: 'Edit Node',
  canvasDeleteNode: 'Delete Node',
  canvasColor: 'Color',
  canvasShape: 'Shape',
  canvasExpand: 'Expand',
  canvasCollapse: 'Collapse',
  canvasTextAlign: 'Text Align',
  canvasAlignTopLeft: 'Top Left',
  canvasAlignCenter: 'Center',
