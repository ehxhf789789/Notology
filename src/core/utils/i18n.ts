...
const ko: Record<string, string> = {
  ...
  attachmentSynced: '동기화 완료',
  attachmentUploading: '업로드 중',
  attachmentOrphan: '연결 없음',
  selectedCount: '{count}개 선택됨',
  attachmentReconcileVerify: '연결 검증',
  attachmentReconcileScanning: '스캔 중...',
  attachmentReconcileApply: '수정 적용',
  attachmentReconcileReview: '검토 후 수정',
  attachmentReconcileTooltip: '본문 wikilink와 첨부 ref가 일치하지 않는 곳을 찾습니다 (안전한 항목은 볼트 열 때 자동 수정됨)',
  attachmentReconcileResultV2: '본문에 깨진 링크 {dummy}개 / 잘못된 ref 주장 {stale}개',
  attachmentReconcileAutoApplied: '(메타데이터 누락 {missing}건은 자동 보정됨)',
  attachmentReconcileAllClean: '모든 첨부 링크가 정합합니다 ✓',
  attachmentReconcileTitle: '연결 검증',
  attachmentReconcileApplyTitle: '{count}건 수정',
  attachmentReconcileWarning: '아래 항목들이 처리됩니다. 깨진 본문 링크는 그 자리에서 제거되고, 잘못된 ref 주장은 풀립니다. 마지막 참조였던 ref는 영구 삭제됩니다 (CAS blob + NAS 사본 포함). 작업은 되돌릴 수 없습니다.',
  attachmentReconcileDummyHeader: '깨진 본문 링크 {count}개 (ref 없는 wikilink 제거):',
  attachmentReconcileStaleHeader: '잘못된 ref 주장 {count}개 (ref → 노트 unlink):',
  attachmentReconcileDoneMsg: '본문 링크 {dummy}개 제거, ref 주장 {stale}개 정리, ref {deleted}개 영구 삭제. 오류 {errors}건.',
  ...
  attachmentStuck: '동기화가 멈춘 것 같습니다',
...
const en: Record<string, string> = {
  ...
  attachmentSynced: 'Synced',
  attachmentUploading: 'Uploading',
  attachmentOrphan: 'No links',
  selectedCount: '{count} selected',
  attachmentReconcileVerify: 'Verify links',
  attachmentReconcileScanning: 'Scanning...',
  attachmentReconcileApply: 'Apply fixes',
  attachmentReconcileReview: 'Review & fix',
  attachmentReconcileTooltip: 'Find mismatches between note-body wikilinks and attachment refs (safe items are auto-fixed at vault open)',
  attachmentReconcileResultV2: '{dummy} broken body link(s) / {stale} stale ref claim(s)',
  attachmentReconcileAutoApplied: '({missing} missing metadata entries already auto-fixed)',
  attachmentReconcileAllClean: 'All attachment links are consistent ✓',
  attachmentReconcileTitle: 'Verify links',
  attachmentReconcileApplyTitle: 'Apply {count} fix(es)',
  attachmentReconcileWarning: 'The items below will be processed. Broken body links are stripped in place; stale ref claims are unlinked. Refs whose last reference was stale get permanently deleted (CAS blob + NAS copy included). This cannot be undone.',
  attachmentReconcileDummyHeader: '{count} broken body link(s) (wikilink → no ref):',
  attachmentReconcileStaleHeader: '{count} stale ref claim(s) (ref → unlink):',
  attachmentReconcileDoneMsg: 'Removed {dummy} body links, unlinked {stale} ref claims, hard-deleted {deleted} refs. {errors} error(s).',
  ...
  attachmentStuck: 'Sync appears stuck',
