...
const ko: Record<string, string> = {
  ...
  attachmentReconcileTooltip: '본문 wikilink와 첨부 ref의 정합성을 검사합니다',
  attachmentReconcileResult: '더미 {dummy}개 / 잘못된 링크 {stale}개 / 누락된 링크 {missing}개',
  attachmentReconcileTitle: '연결 검증',
  attachmentReconcileWarning: '더미 wikilink가 본문에서 제거되고, 잘못된 ref 링크는 풀립니다 (마지막 참조면 ref 자체가 영구 삭제됨).',
...
const en: Record<string, string> = {
  ...
  attachmentReconcileTooltip: 'Compare note bodies to attachment refs and find mismatches',
  attachmentReconcileResult: '{dummy} dummy / {stale} stale / {missing} missing',
  attachmentReconcileTitle: 'Verify links',
  attachmentReconcileWarning: 'Dummy wikilinks will be stripped from note bodies. Stale ref links will be unlinked (last-link refs get permanently deleted).',
