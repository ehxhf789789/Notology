...
export const CANVAS_SHAPE_ICONS: Record<string, React.ReactNode> = {
  process: (
...
export function findTextNodeAtPosition(nodes: CanvasNode[], x: number, y: number): CanvasNode | null {
